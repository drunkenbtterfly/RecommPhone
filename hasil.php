...
<body>
	<!-- Body Start -->
	 <div style="display: flex; justify-content: center; items-align: center;">
            <h5>Hasil Rekomendasi Smartphone</h5>
         </div>
	...
	<div style="background-color: #efefef">
		...
		<div id="about" class="modal">
			<div class="modal-content">
				...
				Sistem ini dibuat sebagai Tugas Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Industri Universitas Andalas.<br>
				<br>
				1. Rahmad Haret Rayhanda | 2010933020<br>
				2. Taufik Sidiq | 2010932036<br>
				3. Hana Izzani Rizqita | 2110931018<br>
			</p>
			</div>
